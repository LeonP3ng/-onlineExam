...
<body>
	<div id="div0" class="bs-example" data-example-id="simple-nav-stacked">
		<ul class="nav nav-pills nav-stacked nav-pills-stacked-example">
			...
			<li><a href="/teacher/findStudent">管理学生</a></li>
		</ul>
	</div>
	<div id="div1">
	...
	<nav aria-label="...">
      <ul class="pagination">
        <li ><a href="/teacher/controlSubject?pn=${PageInfo.pageNum-1}" aria-label="Previous" id="previous"><span aria-hidden="true">«</span></a></li>
      <li><a href="/teacher/controlSubject">首页</a></li>
      <c:forEach begin="1" end="${PageInfo.pages}" var="id">
      <li id="li${id}"><a href="/teacher/controlSubject?pn=${id}">${id}</a></li>
      </c:forEach>
      <li><a href="/teacher/controlSubject?pn=${PageInfo.pages}">尾页</a></li>
        <li><a href="/teacher/controlSubject?pn=${PageInfo.pageNum+1}" aria-label="Next"><span aria-hidden="true" id="next">»</span></a></li>
     </ul>
   </nav>
		</div>
</body>
