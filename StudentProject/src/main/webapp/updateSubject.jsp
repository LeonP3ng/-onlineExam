...
<body>
	<div id="div0" class="bs-example" data-example-id="simple-nav-stacked">
		<ul class="nav nav-pills nav-stacked nav-pills-stacked-example">
			...
			<li class="active"><a href="/teacher/controlSubject">管理试题</a></li>
			<li><a href="findSubject.jsp">查询试题</a></li>
			<li><a href="/teacher/findStudent">管理学生</a></li>
		</ul>
	</div>
	<div id="div1">
		<form class="form-horizontal" method="post" action="/teacher/updateSubject?num=${sessionScope.subject.subjectId} ">
