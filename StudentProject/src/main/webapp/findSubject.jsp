...
<body>
	...
	<div id="div1">
	<form method="post" action="/teacher/findSubject">请输入你要搜索的题目:<input type="text" name="subjectTitle"></input> <button class="btn btn-success" type="submit">查询</button></form>
	</div>
</body>
</html>